        ...
        private static void Main(string[] args)
        {
            ...
            do
            {
                ...
                switch (K.Key)
                {
                    ...
                    case ConsoleKey.NumPad8:
                        {
                            ...
                            while (isComp != true)
                            {
                                Console.WriteLine("\nЗадайте индекс элемента перед которым будет добавлен 999");
                                int n = 0;
                                bool n_t = int.TryParse(Console.ReadLine(), out n);
                                if (n_t)
                                {
                                    if (n >= 0 && n <= linklist.Count())
                                    {
                                        ...
                                        Console.WriteLine("Индекс вне списка");
                                }
                                else
                                    Console.WriteLine("Недопустимое значение");
                            }
                    ...
                    case ConsoleKey.Q: // добавить перед заданным добавить после заданного
                        {
                            bool isComp = false;

                            while (isComp != true)
                            {
                                Console.WriteLine("\nЗадайте индекс элемента после которого будет добавлен 999");
                                int n = 0;
                                bool n_t = int.TryParse(Console.ReadLine(), out n);
                                if (n_t)
                                {
                    ...
                    case ConsoleKey.NumPad0:
                        {
                            ...
                            while (isComp != true)
                            {
                                Console.WriteLine("\nЗадайте индекс элемента перед которым вы хотите удалить элемент");
                                int n = 0;
                                bool n_t = int.TryParse(Console.ReadLine(), out n);
                                if (n_t)
                                {
                            ...
                            while (isComp != true)
                            {
                                Console.WriteLine("\nЗадайте индекс элемента после которого вы хотите удалить элемент");
                                int n = 0;
                                bool n_t = int.TryParse(Console.ReadLine(), out n);
                                if (n_t)
                                {
